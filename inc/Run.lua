...
Token = io.read(724292096:AAFmub-wc-6zeNp2zh8EGWLhKGpEgFmUz0E):gsub(' 710895001:AAFuIWvRBfMcRVnOut5j7eT9iQR6aJD1VaA','')
if Token == '' then
...
SUDO_USER = io.read(797476773):gsub(' 797476773','')
if SUDO_USER == '' then
